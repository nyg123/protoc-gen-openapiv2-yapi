...
import (
	...
	"github.com/nyg123/protoc-gen-openapiv2-yapi/yapi"
	"os"
	"strings"
...
var (
	...
	yapiUrl                        = flag.String("yapi_url", "", "yapi url")
	yapiToken                      = flag.String("yapi_token", "", "yapi token")
)
...
func main() {
	...
	if req.Parameter != nil {
		...
		emitError(errors.New("缺少参数 yapi_url,yapi_token"))
		return
	}
	...
	for _, o := range out {
		...
		err = yapi.Run(content, *yapiUrl, *yapiToken)
		if err != nil {
			emitError(err)
			return
		}
